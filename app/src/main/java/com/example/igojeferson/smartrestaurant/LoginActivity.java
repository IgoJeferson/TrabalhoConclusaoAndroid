...
import com.example.igojeferson.smartrestaurant.MainActivity;
import com.example.igojeferson.smartrestaurant.R;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private boolean isLoginValido() {
        ...
        Usuario usuarioAutenticado = new UsuarioDAO(this).autentica(login);
        if (senha.equals(usuarioAutenticado.getSenha())) {
            return true;
        } else return false;
    }
